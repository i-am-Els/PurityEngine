...
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PSpriteAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PShaderAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PShaderAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PMeshAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PMeshAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PSkeletonAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PSkeletonAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PStaticMeshAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PStaticMeshAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PMaterialAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PMaterialAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PSplineAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PSplineAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PP2DPolygonMeshAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PP2DPolygonMeshAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PSoundSourceAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PSoundSourceAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PP3DSoundSourceAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PP3DSoundSourceAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PLevelAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PLevelAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PParticleAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PParticleAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PRenderMapAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PRenderMapAsset)
CEREAL_REGISTER_TYPE(purity::assetDB::PProjectAsset)
CEREAL_REGISTER_POLYMORPHIC_RELATION(purity::assetDB::PAsset, purity::assetDB::PProjectAsset)
